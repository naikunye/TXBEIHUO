...
export const HomeOverview: React.FC<HomeOverviewProps> = ({ records, stores, onNavigateToList, currentStoreId }) => {
  ...
  // --- CHART 3: Unit Economics Breakdown (Restored & Fixed Dark Mode) ---
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="glass-panel p-6 rounded-3xl border border-white/5 transition-all hover:shadow-md lg:col-span-3">
            <div className="flex justify-between items-center mb-6">
